...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'trayek_submission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kota', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['trayek.Kota'], null=True, blank=True)),
            ('perusahaan', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['trayek.Perusahaan'], null=True, blank=True)),
            ('nomor', self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True, blank=True)),
            ('awal', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True)),
            ('akhir', self.gf('django.db.models.fields.CharField')(default=None, max_length=128, null=True, blank=True)),
            ('rute', self.gf('django.contrib.gis.db.models.fields.LineStringField')(default=None, null=True)),
            ('submission_id', self.gf('django.db.models.fields.CharField')(default='k6X17D', max_length=64)),
    ...
    models = {
        ...
        u'trayek.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'w6X17D'", 'max_length': '64'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
