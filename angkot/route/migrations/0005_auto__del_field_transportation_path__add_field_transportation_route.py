...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('route_transportation', 'path')

        # Adding field 'Transportation.route'
        db.add_column('route_transportation', 'route',
    ...
    def backwards(self, orm):
        ...
        db.add_column('route_transportation', 'path',
                      self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Transportation.route'
        db.delete_column('route_transportation', 'route')
