...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Transportation.path'
        db.delete_column(u'route_transportation', 'path')

        # Adding field 'Transportation.route'
        db.add_column(u'route_transportation', 'route',
                      self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Transportation.path'
        db.add_column(u'route_transportation', 'path',
                      self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Transportation.route'
        db.delete_column(u'route_transportation', 'route')
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'DywF4E'", 'max_length': '64'}),
