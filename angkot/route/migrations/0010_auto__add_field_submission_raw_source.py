...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.raw_source'
        db.add_column(u'route_submission', 'raw_source',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.raw_source'
        db.delete_column(u'route_submission', 'raw_source')
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'rYAWGJ'", 'max_length': '64'}),
