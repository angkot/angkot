...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.province'
        db.add_column(u'route_submission', 'province',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=5, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.province'
        db.delete_column(u'route_submission', 'province')
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'xmF91E'", 'max_length': '64'}),
