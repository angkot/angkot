...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'route_transportation', (
            ...
            ('path', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'route', ['Transportation'])

        # Adding field 'Submission.transportation'
        db.add_column(u'route_submission', 'transportation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='history', null=True, blank=True, to=orm['route.Transportation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Transportation'
        db.delete_table(u'route_transportation')

        # Deleting field 'Submission.transportation'
        db.delete_column(u'route_submission', 'transportation_id')
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'1Qox3E'", 'max_length': '64'}),
        ...
        u'route.transportation': {
            ...
            'origin': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'path': ('django.contrib.gis.db.models.fields.MultiLineStringField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
