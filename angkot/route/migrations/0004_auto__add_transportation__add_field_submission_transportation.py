...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('route_transportation', (
        ...
        db.send_create_signal('route', ['Transportation'])

        # Adding field 'Submission.transportation'
        db.add_column('route_submission', 'transportation',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('route_transportation')

        # Deleting field 'Submission.transportation'
        db.delete_column('route_submission', 'transportation_id')
