...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.ip_address'
        db.alter_column(u'route_submission', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'Submission.user_agent'
        db.alter_column(u'route_submission', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Submission.ip_address'
        raise RuntimeError("Cannot reverse this migration. 'Submission.ip_address' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Submission.user_agent'
        raise RuntimeError("Cannot reverse this migration. 'Submission.user_agent' and its values cannot be restored.")
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'kJAGDJ'", 'max_length': '64'}),
