...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('route_submission', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True))

        # Changing field 'Submission.user_agent'
        db.alter_column('route_submission', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
