...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'route_submission', 'source',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'route_submission', 'source')
    ...
    models = {
        ...
        u'route.submission': {
            ...
            'submission_id': ('django.db.models.fields.CharField', [], {'default': "'1EnEDJ'", 'max_length': '64'}),
