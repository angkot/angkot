...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('line_author', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], default=None, blank=True, null=True)),
        ...
        db.create_table('line_line', (
            ...
            ('province', self.gf('django.db.models.fields.CharField')(max_length=5, default=None, blank=True, null=True)),
        ...
        db.create_table('line_route', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024, default=None, blank=True, null=True)),
            ('path', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(default=None, blank=True, null=True)),
    ...
    models = {
        ...
        'line.author': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'default': 'None', 'blank': 'True', 'null': 'True'}),
        ...
        'line.line': {
            ...
            'province': ('django.db.models.fields.CharField', [], {'max_length': '5', 'default': 'None', 'blank': 'True', 'null': 'True'}),
        ...
        'line.route': {
            ...
            'path': ('django.contrib.gis.db.models.fields.MultiLineStringField', [], {'default': 'None', 'blank': 'True', 'null': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        }
    }
